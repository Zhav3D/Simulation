...
public class CameraController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        transform.RotateAround(transform.position, transform.up, Input.GetAxis("Mouse X") * m_RotationSpeed * Time.deltaTime);
        transform.RotateAround(transform.position, transform.right, -Input.GetAxis("Mouse Y") * m_RotationSpeed * Time.deltaTime);
